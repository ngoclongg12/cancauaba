...
<body class="home page-template-default page page-id-9 wp-custom-logo wp-schema-pro-1.4.1 header-shadow lightbox nav-dropdown-has-arrow">
								...
								<div class="section-content relative">
									...
									<div class="row row-dashed" id="row-797195334">
										<?php while ($row = mysqli_fetch_array($query)) { ?>
											<div id="col-1264949517" class="col medium-3 small-6 large-3">
												<div class="col-inner">
			...
			<div class="footer-widgets footer footer-1">
				<div class="row dark large-columns-3 mb-0">
					...
					<div id="block-5" class="col pb-0 widget widget_block">
						<div class="wp-container-62023f0e44e04 wp-block-group">
					...
					<div id="block-6" class="col pb-0 widget widget_block">
						<div class="wp-container-62023f0e45bd5 wp-block-group">
							<div class="wp-block-group__inner-container">
	...
	<style>
		.wp-container-62023f0e44e04 .alignleft {
			float: left;
			margin-right: 2em;
		}

		.wp-container-62023f0e44e04 .alignright {
			float: right;
			margin-left: 2em;
		}
	</style>
	<style>
		.wp-container-62023f0e45bd5 .alignleft {
			float: left;
			margin-right: 2em;
		}

		.wp-container-62023f0e45bd5 .alignright {
			float: right;
			margin-left: 2em;
		}
	</style>
