            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="title-content">
                        <h2>Kinh nghiệm câu</h2>
                        <ul>
                            <li>
                                <a href="index.html">Trang chủ</a>
                            </li>
                            <li>
                                <span>Câu chuyện hay</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<section class="about-area pt-100 pb-70">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <div class="middle">
                        <ul>
                            <li>
                                <img src="<?= $config ?>/assets/images/about-icon1.png" alt="Icon">
                                <h3>25+ Years Experience</h3>
                            </li>
                            <li>
                                <img src="<?= $config ?>/assets/images/about-icon2.png" alt="Icon">
                                <h3>Trusted Brand In City</h3>
                            </li>
                            <li>
                                <img src="<?= $config ?>/assets/images/about-icon3.png" alt="Icon">
                                <h3>32+ Award Winner</h3>
                            </li>
                            <li>
                                <img src="<?= $config ?>/assets/images/about-icon4.png" alt="Icon">
                        ...
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirm od tempor
                            invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et
                            accusam et justo duo dolores et ea rebum</p>
                        <a class="common-btn" href="<?= $config ?>">
                            Shop Now
            ...
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="<?= $config ?>/assets/images/about-main1.jpg" alt="About">
                    <img src="<?= $config ?>/assets/images/about-main2.jpg" alt="About">
                    <img src="<?= $config ?>/assets/images/about-main3.jpg" alt="About">
                </div>
            </div>
        </div>
    </div>
